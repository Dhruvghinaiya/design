...
const Navbar = () => {
    return (
        <div className="bg-white   flex items-center w-screen   h-21 justify-between ">
            <div className="flex  items-center  gap-3  pl-2 pt-1  sm:text-2xl ">
                <img src="build\assets\icon\header_logo.png" className="w-12  h-12" alt="" />
                <h1 className="tracking-wide  font-bold ">Seamless</h1> 
            </div>
            <div className="flex  items-center  gap-6  text-2xl    sm:pr-10 lg:pr-20 ">
                <div class="search-container relative" >
                    <input
                        ...
                        placeholder="Search..."
                    />
                    <MagnifyingGlassIcon class="absolute  hidden sm:block flex-none right-3 top-6 transform -translate-y-1/2 size-6 " />
                </div>
                ...
                <img
                    ...
                    alt="" 
                    />
                <p className=" text-sm md:text-lg text-black flex mr-1   md:-tracking-tighter font-bold "><span>Justin</span> <span>Watson</span></p>
                        <DotIcon />
                    </div>
            </div>
        </div>
